<x-layouts::auth :title="__('Masuk')">
    <div
        class="flex h-screen items-center justify-center bg-stone-100 bg-pattern-dots p-4 sm:p-6 lg:p-8 dark:bg-stone-950">
        {{-- Card Utama --}}
        <div
            ...
            <div
                ...
                {{-- Dot grid overlay (tetap dipertahankan) --}}
                <div class="bg-pattern-dots pointer-events-none absolute inset-0 opacity-60"></div>

                {{-- Gradient orbs --}}
                <div
                    class="animate-float pointer-events-none absolute -left-16 top-1/4 h-72 w-72 rounded-full bg-emerald-400 opacity-10 blur-[100px]">
                </div>
                <div
                    class="animate-float-slow pointer-events-none absolute bottom-1/3 right-0 h-64 w-64 rounded-full bg-teal-300 opacity-10 blur-[80px]">
                </div>
                ...
                <div class="relative z-10 flex items-center gap-3">
                    ...
                    <div>
                        <p
                            class="font-serif text-xl font-semibold leading-tight tracking-wide text-emerald-900 dark:text-emerald-100">
                            HIBAH DOSEN
                        </p>
                        <p
                            class="font-mono text-[12px] uppercase tracking-widest text-emerald-600/70 dark:text-emerald-400/50">
                ...
                <div class="relative z-10">
                    <p class="font-mono text-[11px] tracking-wider text-emerald-600/70 dark:text-emerald-400/50">
            ...
            <div
                ...
                <div class="w-full max-w-sm">
                    ...
                    <div class="mb-10 flex items-center gap-3 lg:hidden">
                        ...
                        <div>
                            <p class="font-serif text-sm font-semibold dark:text-emerald-50">
                                HIBAH DOSEN</p>
                            <p class="font-mono text-[10px] uppercase tracking-widest">LPPM Annuqayah
                            </p>
                        </div>
                    </div>
                    ...
                    {{-- Heading --}}
                    <div class="mb-8">
                        <h2 class="font-serif mb-2 text-4xl font-bold dark:text-emerald-50">
                            Masuk
                        </h2>
                    ...
                    <form method="POST" action="{{ route('login.store') }}" class="space-y-5">
                        ...
                        <div class="space-y-1.5">
                            <label for="email" class="block text-sm font-medium dark:text-emerald-300">
                                Email
                            </label>
                            <div class="relative">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                                    <svg class="h-4 w-4 text-emerald-300 dark:text-emerald-500" fill="none"
                                ...
                                <input id="email" name="email" type="email" value="{{ old('email') }}" required
                                    ...
                                    class="w-full rounded-xl border bg-emerald-50/50 py-2.5 pl-10 pr-4 text-sm transition-all duration-200 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 dark:text-emerald-100 dark:placeholder-emerald-600" />
                            </div>
                            @error('email')
                        ...
                        <div class="space-y-1.5" x-data="{ show: false }">
                            <div class="flex items-center justify-between">
                                <label for="password" class="block text-sm font-medium dark:text-emerald-300">
                                    Password
                                </label>
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" wire:navigate
                                        class="text-xs font-medium transition-colors hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300">
                                        Lupa Password?
                                    </a>
                                @endif
                            </div>
                            <div class="relative">
                                ...
                                <input id="password" name="password" :type="show ? 'text' : 'password'" required
                                    ...
                                    class="w-full rounded-xl border bg-emerald-50/50 py-2.5 pl-10 pr-11 text-sm transition-all duration-200 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-100 dark:placeholder-emerald-600" />
                        ...
                        <div class="flex items-center">
                            <label class="group flex cursor-pointer items-center gap-2.5">
                                <div class="relative">
                                    ...
                                    <div
                                        class="flex h-4 w-4 items-center justify-center rounded border bg-white transition-all duration-200 group-hover:border-emerald-400 peer-checked:border-emerald-600 peer-checked:bg-emerald-600 dark:border-emerald-700 dark:bg-emerald-950">
                                ...
                                <span class="select-none text-sm dark:text-emerald-300">Ingat
                                    Saya</span>
                            </label>
                        </div>
                    ...
                    <div class="pt-2 dark:border-emerald-900">
                        <a href="{{ url('/') }}"
                            class="group flex items-center justify-center gap-1.5 text-xs text-emerald-400 transition-colors hover:text-emerald-600 dark:text-emerald-500 dark:hover:text-emerald-400">
