...
new class extends Component {
    ...
    {
        // Default role USER untuk halaman users
        $this->form->role_id = Role::query()->where('role_code', 'USER')->value('id');
    }
    ...
    public function save(): void
    {
        try {
            ...
            $this->dispatch('user-added', message: 'User berhasil ditambahkan.');
            $this->form->role_id = Role::query()->where('role_code', 'USER')->value('id');
...
<div
    x-data="{
        ...
        errorMessage: '',
        init() {
            window.addEventListener('open-add-user', () => {
                this.errorMessage = '';
                this.show = true;
            });
