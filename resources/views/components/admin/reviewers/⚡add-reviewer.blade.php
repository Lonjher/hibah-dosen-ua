...
new class extends Component {
    ...
    public function save(): void
    {
        try {
            $this->form->create();
            Flux::toast('Reviewer berhasil ditambahkan.');
            $this->dispatch('reviewer-added', message: 'Reviewer berhasil ditambahkan.');
            $this->form->role_id = Role::query()->where('role_code', 'REVIEWER')->value('id');
...
<div
    x-data="{
        ...
        init() {
            ...
            window.addEventListener('reviewer-added', () => {
                this.show = false;
            });
        }
    }"
            ...
            <div class="flex-1 overflow-y-auto px-5 sm:px-6 py-5 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" wire:model="form.nidn" placeholder="0000000000"
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="form.full_name" placeholder="Nama lengkap"
                            class="block w-full rounded-md shadow-sm text-[12px]
                                   border-slate-300 dark:border-zinc-600 bg-white dark:bg-zinc-800
                                   text-slate-900 dark:text-zinc-100
                                   focus:border-emerald-500 focus:ring-emerald-500 py-2 px-3" />
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="email" wire:model="form.email" placeholder="nama@ua.ac.id"
                            class="block w-full rounded-md shadow-sm text-[12px]
                                   border-slate-300 dark:border-zinc-600 bg-white dark:bg-zinc-800
                                   text-slate-900 dark:text-zinc-100
                                   focus:border-emerald-500 focus:ring-emerald-500 py-2 px-3" />
                    ...
                    <div>
                        ...
                        <input type="password" wire:model="form.password" placeholder="Min. 8 karakter"
                            class="block w-full rounded-md shadow-sm text-[12px]
                                   border-slate-300 dark:border-zinc-600 bg-white dark:bg-zinc-800
                                   text-slate-900 dark:text-zinc-100
                                   focus:border-emerald-500 focus:ring-emerald-500 py-2 px-3" />
                    ...
                    <div>
                        ...
                        <input type="date" wire:model="form.birthday"
                            class="block w-full rounded-md shadow-sm text-[12px]
                                   border-slate-300 dark:border-zinc-600 bg-white dark:bg-zinc-800
                                   text-slate-900 dark:text-zinc-100
                                   focus:border-emerald-500 focus:ring-emerald-500 py-2 px-3 dark:[color-scheme:dark]" />
                        @error('form.birthday')
                            <p class="mt-1 flex items-center gap-1 text-[11px] text-rose-600 dark:text-rose-400">
                                <flux:icon.exclamation-circle class="size-3 shrink-0" /> {{ $message }}
                            </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" wire:model="form.phone_number" placeholder="628xxx"
                            class="block w-full rounded-md shadow-sm text-[12px]
                                   border-slate-300 dark:border-zinc-600 bg-white dark:bg-zinc-800
                                   text-slate-900 dark:text-zinc-100
                                   focus:border-emerald-500 focus:ring-emerald-500 py-2 px-3" />
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="form.address" placeholder="Alamat lengkap"
                            class="block w-full rounded-md shadow-sm text-[12px]
                                   border-slate-300 dark:border-zinc-600 bg-white dark:bg-zinc-800
                                   text-slate-900 dark:text-zinc-100
                                   focus:border-emerald-500 focus:ring-emerald-500 py-2 px-3" />
