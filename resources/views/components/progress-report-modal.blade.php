...
<div x-data="{ show: @entangle('showProgressModal') }"
    x-show="show"
    x-cloak
    ...
    <div x-show="show"
        ...
        class="fixed inset-0 z-[100]
               bg-inverse-surface/50 dark:bg-black/60
               backdrop-blur-xl backdrop-saturate-150"
        wire:click="closeProgressReports"></div>
    ...
    <div x-show="show"
        ...
        class="relative z-[101]
               bg-surface-container-lowest dark:bg-zinc-900 shadow-2xl
               w-full {{ $width }}
            ...
            <div class="flex items-start justify-between gap-3">
                <div class="min-w-0 flex-1">
                    <div class="flex items-center gap-2">
                        <div class="w-7 h-7 rounded-lg bg-white/20
        ...
        <div class="flex-1 overflow-y-auto p-5 sm:p-6 space-y-4">
                ...
                @if ($reports->isEmpty())
                    <div class="p-8 rounded-xl text-center
                        ...
                        <flux:icon.document-chart-bar
                            class="size-8 mx-auto text-outline-variant dark:text-zinc-700" />
                            ...
                            <div class="p-3 rounded-xl border
                                ...
                                <div class="flex items-start justify-between gap-2 mb-1.5">
                                    ...
                                    <div class="flex items-center gap-0.5 shrink-0">
                                        @if ($report->isPending())
                                            <button type="button"
                                                wire:click="editProgressReport({{ $report->id }})"
                                                title="Edit"
                                                class="w-6 h-6 rounded-md flex items-center justify-center
                                                       text-outline hover:text-violet-600
                                                       hover:bg-violet-100
                                            ...
                                            <button type="button"
                                                wire:click="confirmDeleteProgress({{ $report->id }})"
                                                title="Delete"
                                                class="w-6 h-6 rounded-md flex items-center justify-center
                                                       text-outline hover:text-rose-600
                                                       hover:bg-rose-100
            ...
            {{-- ═════════ FORM VIEW ═════════ --}}
            @if ($showForm)
                <form wire:submit.prevent="saveProgressReport" class="space-y-4">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 pt-3
                        ...
                        <button type="submit"
                            ...
                            wire:target="saveProgressReport,progressReportFile,progressPptFile"
                            ...
                            <span wire:loading.remove wire:target="saveProgressReport">
                                {{ $editMode ? 'Update' : 'Submit' }}
                            </span>
                            <span wire:loading.flex wire:target="saveProgressReport"
