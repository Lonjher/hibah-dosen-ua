        ...
        <form wire:submit.prevent="save" class="flex min-h-0 flex-1 flex-col">
            ...
            <div class="flex-1 overflow-y-auto px-5 sm:px-6 py-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea wire:model="form.summary" rows="3" placeholder="Ringkasan progres..."
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <div wire:loading wire:target="report_file" class="mt-1 text-[10px] text-slate-500">
                            Uploading...
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div wire:loading wire:target="ppt_file" class="mt-1 text-[10px] text-slate-500">
                            Uploading...
                        </div>
                    </div>
                </div>
