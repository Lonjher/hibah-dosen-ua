...
new #[Title('Dedication Proposals')] class extends Component {
    use WithPagination;
    ...
    public function with(): array
    {
        ...
        return [
            'proposals' => $proposals,
            'theme' => ['icon' => 'heart', 'color' => 'rose', 'label' => 'Pengabdian'],
        ];
    }
};
?>
            ...
            <table class="w-full min-w-[880px] text-xs">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-zinc-800">
                    @forelse ($proposals as $proposal)
                        ...
                        <tr class="hover:bg-rose-50/30 dark:hover:bg-zinc-800/50 transition-colors">
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-16 text-center text-slate-500 dark:text-slate-400">
                                <div class="flex flex-col items-center gap-3">
                                    <flux:icon.heart class="size-10 text-slate-300 dark:text-zinc-700" />
